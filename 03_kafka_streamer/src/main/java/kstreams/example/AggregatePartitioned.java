...
public class AggregatePartitioned extends StreamApp {

    public static void main(String[] args) throws Exception {
        // Configure the Streams application.
        final Properties streamsConfiguration = getStreamProperties("sensor-aggregate-partitioned");
    ...
    private static void buildStream(StreamsBuilder builder) {
        ...
        KStream<String, SensorData> inputStream = builder.stream("sensor-data-input-partitioned",
